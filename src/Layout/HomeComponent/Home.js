...
/* Home.js page; this is the landing page, renders what should be displayed when you first open the app. 
The only imports here other than react are the API function to list the decks, 
